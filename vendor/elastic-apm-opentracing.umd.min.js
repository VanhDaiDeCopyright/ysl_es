! function() {
    var t = {
            816: function(t, e, n) {
                ...
                ! function(a, s) {
                    "use strict";
                    i = [n(170)], void 0 === (o = "function" == typeof(r = function(t) {
                        var e = /(^|@)\S+\:\d+/,
                            n = /^\s*at .*(\S+\:\d+|\(native\))/m,
                            r = /^(eval@)?(\[native code\])?$/;
            ...
            889: function(t, e, n) {
                ...
                e.childOf = function(t) {
                    return t instanceof o.default && (t = t.context()), new i.default(r.REFERENCE_CHILD_OF, t)
                }, e.followsFrom = function(t) {
                    return t instanceof o.default && (t = t.context()), new i.default(r.REFERENCE_FOLLOWS_FROM, t)
                }
            },
            606: function(t, e, n) {
                "use strict";
                ...
                e.tracer = null, e.spanContext = null, e.span = null, e.initialize = function() {
                    e.tracer = new o.default, e.span = new r.default, e.spanContext = new i.default
                }
            },
            659: function(t, e, n) {
                "use strict";
                ...
                var r = n(889),
                    ...
                    a = function() {
                        ...
                        return t.prototype.startSpan = function(t, e) {
                            ...
                            return t instanceof o.default && (t = t.context()), this._inject(t, e, n)
        ...
        function() {
            ...
            o.prototype.catch = function(t) {
                ...
                return new o((function(e, n) {
                    ...
                    for (var i = 0, a = t.length; i < a; i++) o.resolve(t[i]).then(e, n)
                }))
            ...
            var p = o,
                l = {};
            g ? l = window : "undefined" != typeof self && (l = self);
            var h = "Promise" in l ? l.Promise : p,
                v = [].slice,
                g = "undefined" != typeof window,
                m = g && "undefined" != typeof performance ? performance : {};
            for (var y = [], _ = 0; _ < 256; ++_) y[_] = (_ + 256).toString(16).substr(1);
            ...
            function k(t, e, n) {
                for (var r = 0, i = e.length; r < i; ++r) {
                    var o = e[r];
                    if (I(o) || "function" == typeof o)
                        for (var a = Object.keys(o), s = 0, c = a.length; s < c; s++) {
                            var u = a[s],
                                f = o[u];
                            n && I(f) ? (I(t[u]) || (t[u] = Array.isArray(f) ? [] : {}), k(t[u], [f], !1)) : t[u] = f
                        }
                }
                return t
            }
            ...
            function N(t) {
                return k(t, v.call(arguments, 1), !1)
            }

            function R(t) {
                return k(t, v.call(arguments, 1), !0)
            }
            ...
            function X(t, e, n) {
                ...
                if (r && !(i = r[c])) {
                    ...
                    if (!(s = u) || !1 !== s.writable && ("function" != typeof s.get || void 0 !== s.set)) {
                        ...
                        }, o = r[e], a = i, o[J("OriginalDelegate")] = a
                    }
                }
                return i
            }
            var Y = J("xhrIgnore"),
                ...
                Z = J("xhrMethod"),
                Q = "invoke",
                K = ["link", "css", "script", "img", "xmlhttprequest", "fetch", "beacon", "iframe"],
                tt = "page-load",
                et = [tt, "route-change", "user-interaction", "http-request", "custom", "temporary"];

            function nt(t) {
                var e = XMLHttpRequest.prototype;
                if (e && e.addEventListener) var n = X(e, "open", (function() {
                        return function(t, e) {
                            return t[Y] || (t[Z] = e[0], t[W] = e[1], t[G] = !1 === e[2]), n.apply(t, e)
                        }
                    })),
                    r = X(e, "send", (function() {
                        return function(e, n) {
                            if (e[Y]) return r.apply(e, n);
                            var o = {
            ...
            function ft() {
                return ut || (ut = !0, nt((function(t, e) {
                    ct.send("xmlhttprequest", [t, e])
                })), function(t) {
                    if (at()) {
                        var e = window.fetch;
                        window.fetch = function(t, a) {
                            var s, c, u = this,
                                f = arguments,
                                d = t instanceof URL;
                            if ("string" == typeof t || d) s = new Request(t, a), c = d ? s.url : t;
                            else {
                            ...
                            return new h((function(t, a) {
                                var c;
                                $.fetchInProgress = !0, n(p);
                                try {
                                    c = e.apply(u, [s])
                                } catch (t) {
                                    return a(t), p.data.error = t, r(p), void($.fetchInProgress = !1)
                                }
                                c.then((function(e) {
            ...
            function lt() {
                return E() ? (ft(), dt.bootstrapTime = P(), pt = !0) : g && console.log("[Elastic APM] platform is not supported!"), pt
            }
            ...
            function ht(t, e) {
                ...
                return function(t) {
                    ...
                    var a, s, c = function(t) {
                        ...
                        u = (a = c, s = window.location.origin || window.location.protocol + "//" + window.location.hostname + (window.location.port ? ":" + window.location.port : ""), a.indexOf(s) > -1 && (a = a.replace(s + "/", "")), a);
                    return function(t) {
                            ...
                            if ("string" == typeof d) {
                                if (~(e = i.indexOf(d))) {
                                    ...
                                    if (l) {
                                        ...
                                        e = Math.max(e, h), this[p] = i.slice(0, e), i = i.slice(e + l)
                                    } else this[p] = i.slice(e), i = i.slice(0, e)
                                }
                            } else this[p] = i, i = "";
                            this[p] = this[p] || a && f[3] && s[p] || "", f[3] && (this[p] = this[p].toLowerCase())
                        }
            ...
            function St(t) {
                var e = t.port,
                    ...
                    o = 91 === r.charCodeAt(0) && 93 === r.charCodeAt(r.length - 1),
                    a = r;
                return o && (a = r.slice(1, -1)), {
                    service: {
                        resource: r + ":" + i,
                        name: "",
                        type: ""
                    ...
                    switch (t.type) {
                        case "external":
                            n = function(t) {
                                ...
                                return i && void 0 !== i.status ? e = i.status : o && (e = o.status), c.http.status_code = e, c
                            }(e);
                            break;
                        case "resource":
                            n = function(t) {
            ...
            function wt(t, e) {
                var n = void 0 === e ? {} : e,
                    ...
                    i = bt(),
                    o = {};
                if ("page-exit" === t.type) t.ensureContext(), t.context.page && t.context.page.url && (i.page.url = t.context.page.url);
                else if (t.type === tt && B()) {
                    var a = m.getEntriesByType("navigation");
                    a && a.length > 0 && (o = {
                        response: _t(a[0])
                    })
                }
            ...
            var Ht = function() {
                ...
                Dt = ["fetchStart", "domainLookupStart", "domainLookupEnd", "connectStart", "connectEnd", "requestStart", "responseStart", "responseEnd", "domLoading", "domInteractive", "domContentLoadedEventStart", "domContentLoadedEventEnd", "domComplete", "loadEventStart", "loadEventEnd"],
                Bt = ["fs", "ls", "le", "cs", "ce", "qs", "rs", "re", "dl", "di", "ds", "de", "dc", "es", "ee"];
                ...
                var e = function(t) {
                    ...
                    if (n >= r && i >= n && o >= i) {
                        ...
                        return Dt.forEach((function(r) {
                            var i = t[r];
                            i && i >= n && (V(t) ? a[r] = parseInt(i - e) : a[r] = parseInt(i - n))
                        })), a
                    }
                    return null
                }(t);
            ...
            function Vt(t) {
                ...
                if (n && (e.p = {
                        ...
                        var e = {},
                            ...
                            i = t.url,
                            o = t.response;
                        return e.url = i, n && (e.mt = n), r && (e.sc = r), o && (e.r = zt(o)), e
                    }(r)), i && (e.r = zt(i)), o) {
                    var c = o.service;
                    e.dt = {
                        se: {
            ...
            function $t(t) {
                ...
                var e = function(t) {
                    if (!t) return null;
                    var e = {};
                    return Bt.forEach((function(n, r) {
                        var i = Dt[r];
                        e[n] = t[i]
                    })), e
                }(t.navigationTiming);
            ...
            function Yt(t, e, n) {
                ...
                return new h((function(n, r) {
                    ...
                    if (u[Y] = !0, u.open(t, e, !0), u.timeout = i, u.withCredentials = c, a)
                        for (var f in a) a.hasOwnProperty(f) && u.setRequestHeader(f, a[f]);
            ...
            var Gt = function() {
                function t(t, e) {
                    this._configService = t, this._loggingService = e, this.queue = void 0, this.throttleEvents = F
                }
                var e = t.prototype;
                return e.init = function() {
                    ...
                    return !c && ot(t, a) ? function(t, e, n) {
                        var r, i = n.keepalive,
                            o = void 0 !== i && i,
                            a = n.timeout,
                            s = void 0 === a ? 1e4 : a,
                        ...
                        if ("function" == typeof AbortController) {
                            ...
                            d.signal = p.signal, setTimeout((function() {
                                return p.abort()
                            }), s)
                        }
                        return window.fetch(e, it({
                            body: c,
                            headers: u,
                            method: t,
                            keepalive: o,
                        ...
                        if (n instanceof TypeError) return Yt(t, e, {
                            timeout: o,
                            payload: a,
                            headers: s,
                            beforeSend: c,
                    ...
                    var o = this._configService.get("apmRequest");
                    return this._makeHttpRequest("GET", r, {
                        ...
                        return a && (o.etag = a.replace(/["]/g, ""), n._configService.setLocalConfig(o, !0)), o
                    })).catch((function(t) {
                    ...
                    return t.map((function(t) {
                        var r;
                        return Ht.stringify(((r = {})[n] = e ? function(t) {
                            var e, n = t.exception,
                                r = {
                                    id: t.id,
                                    cl: t.culprit,
                    ...
                    return t.map((function(t) {
                        ...
                        })).join(""), delete t.spans), t.breakdown && (a = n.ndjsonMetricsets(t.breakdown), delete t.breakdown)), Ht.stringify(((i = {})[r] = e ? function(t) {
                        ...
                        if (0 !== r.length || 0 !== i.length) {
                            ...
                            if (u) {
                                var f = s.get("apiVersion") > 2,
                                    ...
                                    l = f ? "m" : "metadata";
                                d.push(Ht.stringify(((n = {})[l] = f ? function(t) {
                                    var e = t.service,
                                        n = t.labels,
                                        r = e.agent,
                                        i = e.language;
                                ...
                                var h = (d = d.concat(this.ndjsonErrors(u.errors, f), this.ndjsonTransactions(u.transactions, f))).join(""),
                                    v = this.getEndpoints().intakeEndpoint;
                                return this._postJson(v, h)
                            }
            ...
            var Zt, Qt = function() {
                    function t() {
                        this.config = {
                            ...
                            apmRequest: null,
                            sendCredentials: !1
                        }, this.events = new st, this.filters = [], this.version = ""
                    }
                    var e = t.prototype;
                    return e.init = function() {
                        var t = function(t) {
                        ...
                        var e = {},
                            ...
                            i = n.username,
                            o = n.email;
                        "number" != typeof r && "string" != typeof r || (e.id = r), "string" == typeof i && (e.username = i), "string" == typeof o && (e.email = o), this.config.context.user = N(this.config.context.user || {}, e)
                    }, e.setCustomContext = function(t) {
                        void 0 === t && (t = {}), this.config.context.custom = N(this.config.context.custom || {}, t)
                        ...
                        var e = t,
                            ...
                            r = e.serverUrl;
                        r && (t.serverUrl = r.replace(/\/+$/, "")), j(n) || (n < 1e-4 && n > 0 && (n = 1e-4), t.transactionSampleRate = Math.round(1e4 * n) / 1e4), R(this.config, t), this.events.send("config:change", [this.config])
                        ...
                        if (t) {
                            if (e) t = Wt({}, this.getLocalConfig(), t);
                ...
                ee = function() {
                    ...
                    return e.init = function() {
                        ...
                        var e = this;
                        return "string" == typeof t ? (this.instances[t] || "function" == typeof te[t] && (this.instances[t] = te[t](this)), this.instances[t]) : Array.isArray(t) ? t.map((function(t) {
            ...
            var ne = function() {
                    ...
                    return e.init = function(t) {
                        ...
                        })), t.history && ct.observe("history", this.getHistorySub()), t.xmlhttprequest && ct.observe("xmlhttprequest", this.getXHRSub()), t.fetch && ct.observe("fetch", this.getFetchSub())
                        ...
                        var t = this;
                        return function(e, n) {
                            "xmlhttprequest" !== n.source || $.fetchInProgress || t.processAPICalls(e, n)
                        }
                        ...
                        if ("schedule" === t && e.data) {
                            var o = e.data,
                                a = new mt(o.url),
                                s = o.method + " " + (a.relative ? a.path : C(a.href));
                            ...
                            var u = n.get("distributedTracing"),
                                ...
                                d = new mt(window.location.href),
                                p = w(a.origin, d.origin) || w(a.origin, f),
                                l = o.target;
                            if (u && p && l) this.injectDtHeader(c, l), n.get("propagateTracestate") && this.injectTSHeader(c, l);
                            else 0;
                            o.sync && (c.sync = o.sync), o.span = c
                        } else if (t === Q) {
                            var h = e.data;
                            if (h && h.span) {
                                var v, g, m = h.span,
                                    y = h.response,
                                    _ = h.target;
                                v = y ? y.status : _.status, g = "abort" == h.status || h.aborted ? "unknown" : v >= 400 || 0 == v ? "failure" : "success", m.outcome = g;
                                var S = r.getCurrentTransaction();
                                S && "http-request" === S.type && (S.outcome = g), r.endSpan(m, h)
                            }
                        }
                ...
                re = function() {
                    function t(t, e, n) {
                        void 0 === n && (n = {}), t || (t = "Unknown"), e || (e = "custom"), this.name = t, this.type = e, this.options = n, this.id = n.id || b(16), this.traceId = n.traceId, this.sampled = n.sampled, this.sampleRate = n.sampleRate, this.timestamp = n.timestamp, this._start = q(n.startTime), this._end = void 0, this.ended = !1, this.outcome = void 0, this.onEnd = n.onEnd
                    }
                    var e = t.prototype;
                    return e.ensureContext = function() {
                        ...
                        this.ended || (this.ended = !0, this._end = q(t), this.callOnEnd())
            ...
            var oe = function(t) {
                    ...
                    return n = t, (e = r).prototype = Object.create(n.prototype), e.prototype.constructor = e, ie(e, n), r.prototype.end = function(e, n) {
                        t.prototype.end.call(this, e), Tt(this, n)
                    }, r
                }(re),
                ae = [
            ...
            function ce(t, e) {
                ...
                return {
                    ...
                    samples: {
                        ...
                        "span.self_time.sum.us": se(1e3 * o)
                    }
                }
            }
            ...
            var fe = function(t) {
                ...
                n = t, (e = r).prototype = Object.create(n.prototype), e.prototype.constructor = e, ue(e, n);
                var i = r.prototype;
                return i.addMarks = function(t) {
                    ...
                    t && (this.name = t), e && (this.type = e), n && (this.options.reuseThreshold = n.reuseThreshold, N(this.options, n))
                    ...
                    if (!this.ended) {
                        for (var e in this.ended = !0, this._end = q(t), this._activeSpans) {
            ...
            function le(t, e) {
                        ...
                        spans: function(t, e) {
                            for (var n = [], r = 0; r < t.length; r++) {
                                ...
                                if (e.count++, e.duration += s, e.max = Math.max(s, e.max), c.length > 0) {
                                    ...
                                    h && (g.name = h), v && (g.id = v), f.addContext({
                                        custom: g
                                    })
                                }
                                f.end(u), n.push(f)
                ...
                if (!n) return o;
                var a = t.getEntriesByType("largest-contentful-paint"),
                    s = a[a.length - 1];
                if (s) {
                    var c = parseInt(s.startTime);
                    pe.lcp = c, o.marks.largestContentfulPaint = c
                }
                var u = m.timing,
                ...
                if (d) {
                    ...
                    pe.fcp = p, o.marks.firstContentfulPaint = p
                }
                var l = function(t) {
                    var e = t[0];
                    if (e) {
                        var n = e.startTime,
                            r = e.processingStart,
                            i = new oe("First Input Delay", "first-input", {
                                startTime: n
                            });
                        return i.end(r), i
                    }
                }(t.getEntriesByType("first-input"));
                return l && (pe.fid = l.duration(), o.spans.push(l)),
                    function(t) {
                        t.forEach((function(t) {
                            var e = t.name,
                                n = t.startTime,
                                r = t.duration;
                            if (!(n < pe.fcp || "self" !== e && -1 === e.indexOf("same-origin"))) {
                                pe.tbt.start = Math.min(pe.tbt.start, n);
                                var i = r - 50;
                                i > 0 && (pe.tbt.duration += i)
                            }
                        }))
                    }(i),
                    function(t) {
                        t.forEach((function(t) {
                            !t.hadRecentInput && t.value && ((t.startTime - pe.cls.firstEntryTime > 5e3 || t.startTime - pe.cls.prevEntryTime > 1e3) && (pe.cls.firstEntryTime = t.startTime, pe.cls.currentSessionScore = 0), pe.cls.prevEntryTime = t.startTime, pe.cls.currentSessionScore += t.value, pe.cls.score = Math.max(pe.cls.score, pe.cls.currentSessionScore))
                        }))
                    }(t.getEntriesByType("layout-shift")), o
            }
            var he = function() {
                function t(t) {
                    this.po = {
            ...
            function _e(t) {
                if (t.captureTimings) {
                    ...
                    if (t.type === tt) {
                        ...
                        var r = m.timing;
                        (function(t, e, n, r) {
                            for (var i = [], o = 0; o < ge.length; o++) {
                                var a = t[ge[o][0]],
                                    s = t[ge[o][1]];
                                if (ve(a, s, n, r, e)) {
                                    var c = new oe(ge[o][2], "hard-navigation.browser-timing"),
                                        u = null;
                                    "requestStart" === ge[o][0] && (c.pageResponse = !0, u = {
                                        url: location.origin
                                    }), c._start = a - e, c.end(s - e, u), i.push(c)
                                }
                            }
                            return i
                        })(r, V(r) ? r.redirectStart : r.fetchStart, 0, e).forEach((function(e) {
                        ...
                        (function(t, e, n, r) {
                            for (var i = [], o = 0; o < t.length; o++) {
                                var a = t[o],
                                    ...
                                    c = a.name,
                                    u = a.startTime,
                                    f = a.responseEnd; - 1 !== K.indexOf(s) && null != c && (("xmlhttprequest" === s || "fetch" === s) && (/intake\/v\d+\/rum\/events/.test(c) || ye(u, e)) || ve(u, f, n, r) && i.push(me(t[o])))
                            }
                            return i
                        })(m.getEntriesByType("resource"), dt.bootstrapTime, i, e).forEach((function(e) {
                ...
                } else t.type === tt && (t._start = 0)
            }
            var Se = function() {
                function t(t, e) {
                    var n = this;
                    this._config = e, this._logger = t, this.currentTransaction = void 0, this.respIntervalId = void 0, this.recorder = new he((function(t) {
                ...
                return e.createCurrentTransaction = function(t, e, n) {
                    ...
                    var r, i = this,
                        ...
                        a = !0;
                    o.managed ? this.currentTransaction === (r = this.startManagedTransaction(t, e, o)) && (a = !1) : r = new fe(t, e, o);
                    ...
                    return h.resolve().then((function() {
                        var r = t.name,
                            i = t.type;
                        if (dt.lastHiddenStart >= t._start) e._config.dispatchEvent("transaction:ignore");
                        else if (e.shouldIgnoreTransaction(r) || "temporary" === i) e._config.dispatchEvent("transaction:ignore");
                        else {
                            if (i === tt) {
                                var o = e._config.get("pageLoadTransactionName");
                                if ("Unknown" === r && o && (t.name = o), t.captureTimings) {
                                    var a = pe.cls,
                                        s = pe.fid,
                                        c = pe.tbt,
                                        u = pe.longtask;
                                    c.duration > 0 && t.spans.push((d = (f = c).start, p = f.duration, (l = new oe("Total Blocking Time", "longtask", {
                                        startTime: d
                                    })).end(d + p), l)), t.experience = {}, U("longtask") && (t.experience.tbt = c.duration), U("layout-shift") && (t.experience.cls = a.score), s > 0 && (t.experience.fid = s), u.count > 0 && (t.experience.longtask = {
                                        count: u.count,
                                        sum: u.duration,
                                        max: u.max
                                    })
                            ...
                            "Unknown" === t.name && (t.name = function(t, e) {
                                void 0 === e && (e = 2);
                                for (var n = new mt(t), r = n.query, i = n.path.substring(1).split("/"), o = /\W|_/g, a = /[0-9]/g, s = /[a-z]/g, c = /[A-Z]/g, u = [], f = !1, d = 0; d < i.length; d++) {
                                    var p = i[d];
                                    if (f || d > e - 1) {
                                        p && u.push("*");
                                        break
                                    }
                                    if ((p.match(o) || []).length >= 2) u.push(":id"), f = !0;
                                    else {
                                        var l = (p.match(a) || []).length;
                                        if (l > 3 || p.length > 3 && l / p.length >= .3) u.push(":id"), f = !0;
                                        else {
                                            var h = (p.match(c) || []).length,
                                                v = (p.match(s) || []).length / p.length,
                                                g = h / p.length;
                                            p.length > 5 && (g > .3 && g < .6 || v > .3 && v < .6) ? (u.push(":id"), f = !0) : p && u.push(p)
                                        }
                                    }
                                }
                                return "/" + (u.length >= 2 ? u.join("/") : u.join("")) + (r ? "?{query}" : "")
                            }(n)), _e(t), e.adjustTransactionTime(t), e._config.get("breakdownMetrics") && t.captureBreakdown();
                            var h = e._config.get("context");
                            wt(t, h), e._config.events.send("transaction:end", [t])
                        }
                    }), (function(t) {
                        0
                    }))
            ...
            function we(t) {
                t.getEntries().forEach((function(t) {
                    t.interactionId && (function(t) {
                        if (z()) return;
                        Te.minInteractionId = Math.min(Te.minInteractionId, t.interactionId), Te.maxInteractionId = Math.max(Te.maxInteractionId, t.interactionId), Te.interactionCount = (Te.maxInteractionId - Te.minInteractionId) / 7 + 1
                    }(t), t.duration < 40 || function(t) {
                        var e = Te.longestInteractions[Te.longestInteractions.length - 1];
                        if (void 0 !== e && t.duration <= e.duration && t.interactionId != e.id) return;
                        var n = Te.longestInteractions.filter((function(e) {
                            return e.id === t.interactionId
                        }));
                        if (n.length > 0) {
                            var r = n[0];
                            r.duration = Math.max(r.duration, t.duration)
                        } else Te.longestInteractions.push({
                            id: t.interactionId,
                            duration: t.duration
                        });
                        Te.longestInteractions.sort((function(t, e) {
                            return e.duration - t.duration
                        })), Te.longestInteractions.splice(10)
                    }(t))
                }))
            }

            function Ee() {
                return performance.interactionCount || Te.interactionCount
            }

            function xe(t) {
                var e = function() {
                    if (0 === Te.longestInteractions.length) return Ee() > 0 ? 0 : void 0;
                    var t = Math.min(Te.longestInteractions.length - 1, Math.floor(Ee() / 50));
                    return Te.longestInteractions[t].duration
                }();
                if (e >= 0) {
                    var n = P(),
                        r = t.startTransaction("page-exit", "page-exit", {
                            startTime: n
                        }),
                    ...
                    var a = n + e + 1;
                    return r.end(a), Te.minInteractionId = 1 / 0, Te.maxInteractionId = 0, Te.interactionCount = 0, Te.longestInteractions = [], r
                }
            }

            function Oe(t, e) {
                if (xe(e)) var n = t.observeEvent("queue:add_transaction", (function() {
                    Ce(t, e), n()
                }));
                else Ce(t, e)
            }
            ...
            function Ce(t, e) {
                ...
                if (n) {
                    var r = t.observeEvent("transaction:ignore", (function() {
                            dt.lastHiddenStart = P(), r(), i()
                        })),
                        i = t.observeEvent("queue:add_transaction", (function() {
                            t.dispatchEvent("queue:flush"), dt.lastHiddenStart = P(), i(), r()
                        }));
                    n.end()
                } else t.dispatchEvent("queue:flush"), dt.lastHiddenStart = P()
            }
                ...
                var e = function(e) {
                    e.target instanceof Element && function(t, e) {
                        var n = function(t) {
                            ...
                            r = n.transactionName,
                            i = n.context,
                            o = t.startTransaction("Click - " + r, "user-interaction", {
                                managed: !0,
                                canReuse: !0,
                                reuseThreshold: 300
                            });
                ...
                return e.isEnabled = function() {
                    ...
                    if (this.isEnabled() && !this._initialized) {
                        ...
                        if (i.setLevel(a), r.get("active")) {
                            ...
                            var s = function(t, e) {
                                var n, r = ((n = {}).xmlhttprequest = !1, n.fetch = !1, n.history = !1, n[tt] = !1, n.error = !1, n.eventtarget = !1, n.click = !1, n);
                            ...
                            var u = function() {
                                return s[tt] && e._sendPageLoadMetrics()
                            };
                            r.get("centralConfig") ? this.fetchCentralConfig().then(u) : u(),
                                function(t, e) {
                                    "hidden" === document.visibilityState && (dt.lastHiddenStart = 0);
                                    var n = function() {
                                            "hidden" === document.visibilityState && Oe(t, e)
                                        },
                                        r = function() {
                                            return Oe(t, e)
                                        };
                                    window.addEventListener("visibilitychange", n, !0), window.addEventListener("pagehide", r, !0)
                                }(r, o), s.eventtarget && s.click && Ie(o),
                                function(t) {
                                    void 0 === t && (t = new he(we));
                                    var e = z(),
                                        n = e ? 40 : 16;
                                    t.start("event", {
                                        buffered: !0,
                    ...
                    var t = this.startTransaction(void 0, tt, {
                        managed: !0,
                        canReuse: !0
                    });
                    if (t) {
                    ...
                    if (0 === o.length && 0 === a.length) n.setConfig(t);
                    else {
                        var u = "RUM agent isn't correctly configured. ";
                        o.length > 0 && (u += o.join(", ") + " is missing", a.length > 0 && (u += ", ")), a.forEach((function(t, e) {
                            var n = t.key,
                                r = t.value,
                                i = t.allowed;
                            u += n + ' "' + r + '" contains invalid characters! (allowed: ' + i + ")" + (e !== a.length - 1 ? ", " : "")
            ...
            var Ae = function(t) {
                ...
                function r(e, n) {
                    var r;
                    return (r = t.call(this) || this).__tracer = e, r.span = n, r.isTransaction = n instanceof fe, r.spanContext = {
                        id: n.id,
                        traceId: n.traceId,
                        sampled: n.sampled
                    }, r
                }
                n = t, (e = r).prototype = Object.create(n.prototype), e.prototype.constructor = e, Fe(e, n);
                var i = r.prototype;
                return i._context = function() {
                    return this.spanContext
                }, i._tracer = function() {
                    return this.__tracer
                }, i._setOperationName = function(t) {
                    this.span.name = t
                }, i._addTags = function(t) {
                    var e = N({}, t);
                    if (e.type && (this.span.type = e.type, delete e.type), this.isTransaction) {
                        var n = e["user.id"],
                            r = e["user.username"],
                            i = e["user.email"];
                        (n || r || i) && (this.span.addContext({
                            user: {
                                id: n,
                                username: r,
                                email: i
                            }
                        }), delete e["user.id"], delete e["user.username"], delete e["user.email"])
                    }
                    this.span.addLabels(e)
                }, i._log = function(t, e) {
                    "error" === t.event && (t["error.object"] ? this.__tracer.errorLogging.logError(t["error.object"]) : t.message && this.__tracer.errorLogging.logError(t.message))
                }, i._finish = function(t) {
                    this.span.end(), t && (this.span._end = t - O())
                }, r
            }(je.Span);
            ...
            var Pe = function(t) {
                ...
                function r(e, n, r, i) {
                    var o;
                    return (o = t.call(this) || this).performanceMonitoring = e, o.transactionService = n, o.loggingService = r, o.errorLogging = i, o
                }
                n = t, (e = r).prototype = Object.create(n.prototype), e.prototype.constructor = e, Me(e, n);
                var i = r.prototype;
                return i._startSpan = function(t, e) {
                    var n, r = {
                        managed: !0
                    };
                    if (e)
                        if (r.timestamp = e.startTime, e.childOf) r.parentId = e.childOf.id;
                        else if (e.references && e.references.length > 0) {
                        e.references.length;
                        var i = function(t, e, n) {
                            ...
                            for (var o = 0; o < i;) {
                                var a = r[o];
                                if (e.call(n, a, o, r)) return a;
                                o++
                            }
                        }(e.references, (function(t) {
                            return t.type() === Re.REFERENCE_CHILD_OF
                        }));
                        i && (r.parentId = i.referencedContext().id)
                    }
                    if (!(n = this.transactionService.getCurrentTransaction() ? this.transactionService.startSpan(t, void 0, r) : this.transactionService.startTransaction(t, void 0, r))) return new je.Span;
                    r.timestamp && (n._start = r.timestamp - O());
                    var o = new Ae(this, n);
                    return e && e.tags && o.addTags(e.tags), o
                }, i._inject = function(t, e, n) {
                    switch (e) {
                        case Re.FORMAT_TEXT_MAP:
                        case Re.FORMAT_HTTP_HEADERS:
                            this.performanceMonitoring.injectDtHeader(t, n);
                            break;
                        case Re.FORMAT_BINARY:
                            0
                    }
                }, i._extract = function(t, e) {
                    var n;
                    switch (t) {
                        case Re.FORMAT_TEXT_MAP:
                        case Re.FORMAT_HTTP_HEADERS:
                            n = this.performanceMonitoring.extractDtHeader(e);
                            break;
                        case Re.FORMAT_BINARY:
                            0
                    }
            ...
            function qe(t) {
                return t._disable ? new Ne.Tracer : (e = t.serviceFactory, n = e.getService("PerformanceMonitoring"), r = e.getService("TransactionService"), i = e.getService("ErrorLogging"), o = e.getService("LoggingService"), new Pe(n, r, o, i));
                var e, n, r, i, o
            }
            "undefined" != typeof window && window.elasticApm && (window.elasticApm.createTracer = qe.bind(window.elasticApm, window.elasticApm))
        }()
}();
