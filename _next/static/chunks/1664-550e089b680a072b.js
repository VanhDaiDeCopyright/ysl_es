    ...
    [1664], {
        ...
        10030: function(e, t, n) {
            ...
            function getDomainLocale(e, t, o, l) {
                {
                    let u = n(33530).normalizeLocalePath,
                        a = n(16728).detectDomainLocale,
                        f = t || u(e, o).detectedLocale,
                        i = a(l, void 0, f);
                    if (i) {
                        let t = "http" + (i.http ? "" : "s") + "://",
                            n = f === i.defaultLocale ? "" : "/" + f;
        ...
        65170: function(e, t, n) {
            ...
            let v = o.default.forwardRef(function(e, t) {
                    ...
                    n = v, L && ("string" == typeof n || "number" == typeof n) && (n = o.default.createElement("a", null, n));
                    let R = o.default.useContext(c.RouterContext),
                        A = o.default.useContext(s.AppRouterContext),
                        I = null != R ? R : A,
                        k = !R,
                        S = !1 !== _,
                        N = null === _ ? b.PrefetchKind.AUTO : b.PrefetchKind.FULL,
                        {
                            href: x,
                            as: U
                        } = o.default.useMemo(() => {
                            if (!R) {
                                ...
                                return {
                                    href: e,
                                    as: y ? formatStringOrUrl(y) : e
                                }
                            }
                            let [e, t] = (0, l.resolveHref)(R, a, !0);
                            return {
                                href: e,
                                as: y ? (0, l.resolveHref)(R, y) : t || e
                            }
                        }, [R, a, y]),
                        w = o.default.useRef(x),
                        z = o.default.useRef(U);
                    L && (r = o.default.Children.only(n));
                    let D = L ? r && "object" == typeof r && r.ref : t,
                        [K, F, H] = (0, d.useIntersection)({
                            rootMargin: "200px"
                        }),
                        V = o.default.useCallback(e => {
                            (z.current !== U || w.current !== x) && (H(), z.current = U, w.current = x), K(e), D && ("function" == typeof D ? D(e) : "object" == typeof D && (D.current = e))
                        }, [U, D, x, H, K]);
                    o.default.useEffect(() => {
                        I && F && S && prefetch(I, x, U, {
                            locale: C
                        }, {
                            kind: N
                        }, k)
                    }, [U, x, F, C, S, null == R ? void 0 : R.locale, I, k, N]);
                    let q = {
                        ref: V,
                        onClick(e) {
                            L || "function" != typeof E || E(e), L && r.props && "function" == typeof r.props.onClick && r.props.onClick(e), I && !e.defaultPrevented && function(e, t, n, r, l, a, f, i, c, s) {
                                let {
                                    nodeName: d
                        ...
                        onMouseEnter(e) {
                            L || "function" != typeof j || j(e), L && r.props && "function" == typeof r.props.onMouseEnter && r.props.onMouseEnter(e), I && (S || !k) && prefetch(I, x, U, {
                                locale: C,
                                priority: !0,
                        ...
                        onTouchStart(e) {
                            L || "function" != typeof M || M(e), L && r.props && "function" == typeof r.props.onTouchStart && r.props.onTouchStart(e), I && (S || !k) && prefetch(I, x, U, {
                                locale: C,
                                priority: !0,
                                bypassPrefetchedCheck: !0
                            }, {
                    ...
                    else if (!L || g || "a" === r.type && !("href" in r.props)) {
                        let e = void 0 !== C ? C : null == R ? void 0 : R.locale,
                            t = (null == R ? void 0 : R.isLocaleDomain) && (0, p.getDomainLocale)(U, e, null == R ? void 0 : R.locales, null == R ? void 0 : R.domainLocales);
                        q.href = t || (0, h.addBasePath)((0, i.addLocale)(U, e, null == R ? void 0 : R.defaultLocale))
                    }
                    return L ? o.default.cloneElement(r, q) : o.default.createElement("a", { ...T,
                        ...q
                    }, n)
                }),
                _ = v;
        ...
        33530: function(e, t, n) {
            ...
            let normalizeLocalePath = (e, t) => n(11774).normalizeLocalePath(e, t);
            ("function" == typeof t.default || "object" == typeof t.default && null !== t.default) && void 0 === t.default.__esModule && (Object.defineProperty(t.default, "__esModule", {
                value: !0
            }), Object.assign(t.default, t), e.exports = t.default)
        },
        40920: function(e, t, n) {
            ...
            function useIntersection(e) {
                let {
                    ...
                    rootMargin: n,
                    disabled: f
                } = e, i = f || !l, [c, s] = (0, r.useState)(!1), d = (0, r.useRef)(null), p = (0, r.useCallback)(e => {
                    d.current = e
                }, []);
                (0, r.useEffect)(() => {
                    if (l) {
